        ...
        $array3 = $con->query("select * from userAccounts where accountNo = '$_POST[otherNo]'");
        {
          ...
          { $row2 = $array2->fetch_assoc();
            echo "<div class='row'>
                  ...
                  <div class='col'>
                    Bank Balance
                    <input type='text' class='form-control my-1'  value='$row2[balance] SAR' readonly required>
           ...
           $row2 = $array3->fetch_assoc();
            ...
            <div class='row'>
                  <div class='col'>
                    ...
                    Account Holder Bank Name.
                    <input type='text' class='form-control' value='IMAMU BANK' readonly required>Bank Balance
                    <input type='text' class='form-control my-1'  value='$row2[balance] SAR' readonly required>
